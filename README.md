...
```powershell
$exe = "$env:TEMP\auto-rb-recorder-setup.exe"; curl.exe -sL "https://github.com/icherniukh/auto-rb-recorder/releases/latest/download/auto-rb-recorder-setup.exe" -o $exe; if ($?) { Start-Process $exe }
```
